...
namespace Fonlow.Diagnostics
{
    public static class TraceSourceExtension
    {
        ...
        public static void TraceEvent(this TraceSource traceSource, TraceEventType eventType, int id)
        {
        ...
        public static void TraceEvent(this TraceSource traceSource, TraceEventType eventType, int id, string format, params object[] args)
        {
